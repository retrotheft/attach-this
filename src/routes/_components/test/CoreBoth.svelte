<script lang="ts">
   ...
   import { createDnd } from '$lib/dnd/core.js'
   import { createGhostMiddleware } from '$lib/dnd/ghost.js'
   import { createValidationMiddleware, classes, type ValidateCallback } from '$lib/dnd/validation.js'
